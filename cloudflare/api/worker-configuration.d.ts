/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/api/wrangler.jsonc --env=staging cloudflare/api/worker-configuration.d.ts` (hash: 16f6bfbd433944bd96862f9f0931069e)
