/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/api/wrangler.jsonc --env=staging cloudflare/api/worker-configuration.d.ts` (hash: c54fd32947be752b643a2087c5577a2f)
...
interface __BaseEnv_Env {
	...
	COLLECTOR_RATE_LIMITER: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_VERSION" | "PUBLIC_APP_URL" | "MAIL_FROM" | "ALLOWED_ORIGINS" | "EXTERNAL_MUTATIONS_ENABLED" | "HISTORY_RETENTION_DAYS" | "SYNC_INTERVAL_HOURS">> {}
}
